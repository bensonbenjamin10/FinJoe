  ...
  // Recurring expense templates (admin, finance only)
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        vendorName: { type: Type.STRING, description: "Vendor name (optional)" },
        gstin: { type: Type.STRING, description: "GSTIN (15 chars, optional)" },
        taxType: { type: Type.STRING, description: "no_gst, gst_itc, gst_rcm, or gst_no_itc (optional)" },
        invoiceNumber: { type: Type.STRING, description: "Invoice number pattern (optional)" },
        voucherNumber: { type: Type.STRING, description: "Voucher number pattern (optional)" },
